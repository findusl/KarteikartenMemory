...
import de.lehrbaum.view.CreateCardPanel;
import de.lehrbaum.view.GamePanel;
import de.lehrbaum.view.MainFrame;
import de.lehrbaum.view.MainMenu;
...
public class Controller {
	...
	public Controller() {
		...
		menu = new MainMenu(this, new String[] {});
		cardPairs = reader.getCardPairs();
	}
	
	public void startGameClicked(String[] categories) {
		if (cardPairs.size() == 0) {
	...
	public void addCard(String name, String cat, String descr) {
	...
	public void fieldClicked(int position) {
		...
		if (gameCards[position].isLocked)
			return; //locked cards can't be removed
